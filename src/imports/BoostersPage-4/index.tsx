import svgPaths from "./svg-tr4xd1j9yq";
...
function Condition() {
  return (
    <div className="relative shrink-0 w-full" data-name="Condition">
      <div className="flex flex-row items-center size-full">
        <div className="content-center flex flex-wrap gap-y-[8px] items-center px-[16px] py-[24px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Roboto:Regular',sans-serif] font-normal leading-[normal] min-w-px relative text-[14px] text-[rgba(0,0,0,0.45)] text-center" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Logic() {
  return (
    <div className="relative rounded-[8px] shrink-0 w-full z-[2]" data-name="Logic">
      ...
      <div aria-hidden className="absolute border border-[#f0f0f0] border-dashed inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
