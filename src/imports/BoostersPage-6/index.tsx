import svgPaths from "./svg-cvd88ygrps";
    ...
    <div className="bg-[#fafafa] relative shrink-0 w-full" data-name="Row">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[8px] relative size-full">
          ...
          <BranchButton />
          <div className="bg-white relative rounded-[100px] shrink-0 size-[24px]" data-name="Delete button">
            <div className="content-stretch flex gap-[4px] items-center justify-center overflow-clip p-[5px] relative rounded-[inherit] size-full">
              <div className="bg-[rgba(255,255,255,0)] relative shrink-0" data-name="Icon-Wrapper">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center overflow-clip relative rounded-[inherit] size-full">
                  <div className="overflow-clip relative shrink-0 size-[14px]" data-name="bx-trash">
                    <div className="absolute inset-[8.33%_12.5%]" data-name="icon">
                      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.5 11.6667">
                        <g id="icon">
                          <path d={svgPaths.p7f5a200} fill="var(--fill-0, #FF4D4F)" />
                          <path d={svgPaths.p1c8d8700} fill="var(--fill-0, #FF4D4F)" />
                        </g>
                      </svg>
                    </div>
                  </div>
...
function Icon11() {
  return (
    <div className="h-[6.857px] relative shrink-0 w-[16.178px]" data-name="icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.1779 6.85736">
        <g id="icon">
          <path d={svgPaths.p1cdbe580} fill="var(--fill-0, black)" fillOpacity="0.25" id="icon_2" />
        </g>
      </svg>
    </div>
  );
...
function Select() {
  return (
    <div className="content-stretch flex items-start relative rounded-[8px] shrink-0 w-[636px]" data-name="Select">
      <Wrapper />
      <div className="absolute bg-white content-stretch flex flex-col items-start left-[-15px] opacity-0 overflow-clip py-[4px] right-[223px] rounded-[8px] shadow-[0px_3px_6px_-4px_rgba(0,0,0,0.12),0px_6px_16px_0px_rgba(0,0,0,0.08),0px_9px_28px_8px_rgba(0,0,0,0.05)] top-[38px]" data-name="Dropdown">
...
function Input1() {
  return (
    <div className="flex-[1_0_0] min-w-px relative rounded-[8px]" data-name="input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[4px] items-center px-[12px] py-[8px] relative size-full">
          <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px relative text-[14px] text-[rgba(0,0,0,0.85)]" style={{ fontVariationSettings: '"wdth" 100' }}>
            <p className="leading-[normal]">Emilia</p>
          </div>
        </div>
      </div>
    </div>
...
function Check() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-[920px]" data-name="Check">
      <div className="overflow-clip relative shrink-0 size-[12px]" data-name="bx-check-circle">
        <div className="absolute inset-[8.33%]" data-name="icon">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
            <g id="icon">
              <path d={svgPaths.pa062a00} fill="var(--fill-0, #52C41A)" />
              <path d={svgPaths.p2fc17630} fill="var(--fill-0, #52C41A)" />
            </g>
          </svg>
        </div>
      </div>
      <p className="[word-break:break-word] font-['Roboto:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#52c41a] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        Condición lista
      </p>
    </div>
  );
...
function Row1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-[828px]" data-name="Row">
      <div className="content-stretch flex items-start overflow-clip relative rounded-[100px] shrink-0" data-name="Segmented-Group">
        <div className="bg-[rgba(0,0,0,0.04)] content-stretch flex items-center p-[4px] relative rounded-[8px] shrink-0" data-name="LayoutBlocks/horizontal×2">
          <div className="bg-[rgba(255,255,255,0)] content-stretch flex gap-[4px] items-center overflow-clip px-[8px] py-[2px] relative rounded-[100px] shrink-0" data-name="Selected=false, Disabled=false, Size=small">
          ...
          <div className="bg-white content-stretch flex gap-[4px] items-center overflow-clip px-[8px] py-[2px] relative rounded-[100px] shadow-[0px_2px_8px_0px_rgba(0,0,0,0.05)] shrink-0" data-name="Selected=true, Disabled=false, Size=small">
...
function Icon14() {
  return (
    <div className="h-[6.857px] relative shrink-0 w-[16.178px]" data-name="icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.1779 6.85736">
        <g id="icon">
          <path d={svgPaths.p1825e500} fill="var(--fill-0, black)" fillOpacity="0.25" id="icon_2" />
        </g>
      </svg>
    </div>
  );
...
function Select1() {
  return (
    <div className="content-stretch flex items-start relative rounded-[8px] shrink-0 w-[620px]" data-name="Select">
      <Wrapper1 />
      <div className="absolute flex items-center justify-center left-[-132px] right-[106px] top-[38px]" style={{ containerType: "size" }}>
        <div className="-scale-x-100 flex-none h-[100cqh] w-[100cqw]">
          <div className="bg-white content-stretch flex flex-col items-start opacity-0 overflow-clip py-[4px] relative rounded-[8px] shadow-[0px_3px_6px_-4px_rgba(0,0,0,0.12),0px_6px_16px_0px_rgba(0,0,0,0.08),0px_9px_28px_8px_rgba(0,0,0,0.05)] w-full" data-name="Dropdown">
            <div className="relative shrink-0 w-full" data-name="Components/Dropdown/Menu-Item">
              <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                <div className="content-stretch flex items-center px-[12px] py-[8px] relative size-full">
                  <p className="[word-break:break-word] font-['Roboto:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[14px] text-[rgba(0,0,0,0.85)] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Placeholder() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px overflow-clip relative" data-name="placeholder">
      <div className="[word-break:break-word] flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[14px] text-[rgba(0,0,0,0.25)] text-left whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">example</p>
      </div>
    </div>
  );
}
...
function SubCondition() {
  return (
    <div className="flex-[1_0_0] min-w-px relative" data-name="Sub-condition">
      <div aria-hidden className="absolute border-[#e6f7ff] border-l-2 border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-center flex flex-wrap gap-[8px] items-center pl-[16px] py-[8px] relative size-full">
          <Row1 />
          ...
          <Select1 />
          <div className="content-stretch flex flex-col items-start relative rounded-[8px] shrink-0 w-[200px]" data-name="Vertical-Form-Item/Select">
          ...
          <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative rounded-[8px]" data-name="Vertical-Form-Item/Input">
    ...
    <div className="relative shrink-0 w-full" data-name="Condition">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-center flex flex-wrap gap-[8px] items-center p-[16px] relative size-full">
          ...
          <div className="content-stretch flex flex-col items-start relative rounded-[8px] shrink-0 w-[636px]" data-name="Vertical-Form-Item/Input">
            <div className="bg-white relative rounded-[8px] shrink-0 w-full" data-name="Field">
              <div className="content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
                <Input1 />
              </div>
