import svgPaths from "./svg-re0588yhdk";
  ...
  return (
    <div className="h-[6.857px] relative shrink-0 w-[16.178px]" data-name="icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.1779 6.85736">
        <g id="icon">
          <path d={svgPaths.p27f6eec0} fill="var(--fill-0, black)" fillOpacity="0.25" id="icon_2" />
        </g>
      </svg>
    </div>
  );
...
function Logic() {
  return (
    <div className="relative rounded-[8px] shrink-0 w-full z-[3]" data-name="Logic">
    ...
    <div className="relative shrink-0 w-full" data-name="Condition">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-center flex flex-wrap gap-[8px] items-center p-[16px] relative size-full">
          ...
          <div className="bg-white content-stretch flex items-start px-[12px] py-[8px] relative rounded-[8px] shrink-0 w-[636px]" data-name="Select">
            <div aria-hidden className="absolute border border-[#d9d9d9] border-solid inset-0 pointer-events-none rounded-[8px]" />
            <SelectionItem4 />
            <Icon14 />
            <div className="absolute bg-white content-stretch flex flex-col items-start left-0 opacity-0 overflow-clip py-[4px] right-0 rounded-[8px] shadow-[0px_3px_6px_-4px_rgba(0,0,0,0.12),0px_6px_16px_0px_rgba(0,0,0,0.08),0px_9px_28px_8px_rgba(0,0,0,0.05)] top-[38px]" data-name="Dropdown">
              <div className="relative shrink-0 w-full" data-name="Components/Dropdown/Menu-Item">
                <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                  <div className="content-stretch flex items-center px-[12px] py-[8px] relative size-full">
                    <p className="[word-break:break-word] font-['Roboto:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[14px] text-[rgba(0,0,0,0.85)] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
